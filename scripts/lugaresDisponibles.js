    ...
    card.innerHTML = `
      ...
      <div class="lugar-content">
        ...
        <div class="lugar-info">
          <span class="lugar-capacidad">👥 ${lugar.capacidad} personas</span>
          <span class="lugar-precio">💰 ${lugar.precio || 'Gratis'}</span>
        </div>
...
function filterLugares() {
  ...
  let filtered = lugares.filter(lugar => {
...
function verDetalles(id) {
  ...
  modalContent.innerHTML = `
    ...
    <p><strong>Precio:</strong> ${lugar.precio || 'Gratis'}</p>
